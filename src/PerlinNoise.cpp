...
PerlinNoise::PerlinNoise() {
  std::copy(s_permutations.begin(), s_permutations.end(),
            m_permutations.begin());
  std::copy(s_permutations.begin(), s_permutations.end(),
            m_permutations.begin() + 256);
}

PerlinNoise::PerlinNoise(float seed) {
  std::iota(m_permutations.begin(), m_permutations.begin() + 256,
            0); // Fill with 0-255
  ...
  std::copy(m_permutations.begin(), m_permutations.begin() + 256,
            m_permutations.begin() + 256);
}
